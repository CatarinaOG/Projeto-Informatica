...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.bosch.diabo.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.bosch.diabo.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, com.bosch.diabo.domain.User.class.getName());
