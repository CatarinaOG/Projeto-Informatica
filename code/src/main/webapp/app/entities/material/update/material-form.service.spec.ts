      ...
      it('should create a new form with FormControl', () => {
        ...
        expect(formGroup.controls).toEqual(
          expect.objectContaining({
            ...
            dateNewSS: expect.any(Object),
            datNewST: expect.any(Object),
            previousSS: expect.any(Object),
            previousST: expect.any(Object),
            datePreviousSS: expect.any(Object),
            datePreviousST: expect.any(Object),
