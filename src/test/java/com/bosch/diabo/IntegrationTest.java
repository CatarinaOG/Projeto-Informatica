...
import com.bosch.diabo.DiaboApp;
import com.bosch.diabo.config.AsyncSyncConfiguration;
import com.bosch.diabo.config.EmbeddedSQL;
...
@SpringBootTest(classes = { DiaboApp.class, AsyncSyncConfiguration.class })
@EmbeddedSQL
